...
- l(x, y) = (2·μ<sub>x</sub>·μ<sub>y</sub> + c<sub>1</sub>) / (μ<sub>x</sub><sup>2</sup> + μ<sub>y</sub><sup>2</sup> + c<sub>1</sub>)
- c(x, y) = (2·σ<sub>x</sub>·σ<sub>y</sub> + c<sub>2</sub>) / (σ<sub>x</sub><sup>2</sup> + σ<sub>y</sub><sup>2</sup> + c<sub>2</sub>)
